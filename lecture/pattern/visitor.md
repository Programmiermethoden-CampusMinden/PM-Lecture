...
direct.DemoExpr (https://github.com/Programmiermethoden-CampusMinden/PM-Lecture/blob/master/markdown/pattern/src/visitor/direct/DemoExpr.java)</p>
...
visitor.visit.intrav.DemoExpr (https://github.com/Programmiermethoden-CampusMinden/PM-Lecture/blob/master/markdown/pattern/src/visitor/visit/intrav/DemoExpr.java)</p>

<p align="right">Beispiel Traversierung extern (im Visitor):
visitor.visit.extrav.DemoExpr (https://github.com/Programmiermethoden-CampusMinden/PM-Lecture/blob/master/markdown/pattern/src/visitor/visit/extrav/DemoExpr.java)</p>
