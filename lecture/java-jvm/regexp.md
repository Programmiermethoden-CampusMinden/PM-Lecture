...
<p align="right">Demo:
regexp.StringSplit (https://github.com/Programmiermethoden-CampusMinden/PM-Lecture/blob/master/markdown/java-jvm/src/regexp/StringSplit.java)</p>
...
<p align="right">Demo:
regexp.MatchFind (https://github.com/Programmiermethoden-CampusMinden/PM-Lecture/blob/master/markdown/java-jvm/src/regexp/MatchFind.java)</p>
...
<p align="right">Demo:
regexp.Quantifier (https://github.com/Programmiermethoden-CampusMinden/PM-Lecture/blob/master/markdown/java-jvm/src/regexp/Quantifier.java)</p>
...
<p align="right">Demo:
regexp.Groups (https://github.com/Programmiermethoden-CampusMinden/PM-Lecture/blob/master/markdown/java-jvm/src/regexp/Groups.java)</p>
...
<p align="right">Demo:
regexp.Backref (https://github.com/Programmiermethoden-CampusMinden/PM-Lecture/blob/master/markdown/java-jvm/src/regexp/Backref.java)</p>
