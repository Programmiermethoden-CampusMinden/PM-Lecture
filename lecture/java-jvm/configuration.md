...
<p align="right">Demo IDE und CLI (https://youtu.be/a3XUfDbD9uo)</p>
...
<p align="right">Demo: Einbinden von Libs,
cli.Args (https://github.com/Programmiermethoden-CampusMinden/PM-Lecture/blob/master/markdown/java-jvm/src/cli/Args.java)</p>
...
<p align="right">Demo: cli.Props, Hinweis auf “Apache Commons
Configuration” (https://github.com/Programmiermethoden-CampusMinden/PM-Lecture/blob/master/markdown/java-jvm/src/cli/Props.java)</p>
