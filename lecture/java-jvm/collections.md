...
> Objekte speichern kann: Listen, Queues, Mengen, ... Für diese Typen
> gibt es jeweils verschiedene Implementierungen mit einem spezifischen
...
iterator_example.\* (https://github.com/Programmiermethoden-CampusMinden/PM-Lecture/tree/master/markdown/java-jvm/src/collections/iterator_example/)</p>
...
<p align="right">Beispiel:
hash_example.HashCodeExample (https://github.com/Programmiermethoden-CampusMinden/PM-Lecture/blob/master/markdown/java-jvm/src/collections/hash_example/HashCodeExample.java)</p>
