...
enums.v1.Studi (https://github.com/Programmiermethoden-CampusMinden/PM-Lecture/blob/master/markdown/java-jvm/src/enums/v1/Studi.java)</p>
...
- Attribute: `final` Attribute können nur einmal gesetzt werden
  ...
  <p align="right">Beispiel
  enums.FinalDemo (https://github.com/Programmiermethoden-CampusMinden/PM-Lecture/blob/master/markdown/java-jvm/src/enums/FinalDemo.java)</p>
...
<p align="right">Demo:
enums.v2.Studi (https://github.com/Programmiermethoden-CampusMinden/PM-Lecture/blob/master/markdown/java-jvm/src/enums/v2/Studi.java)</p>
...
<p align="right">Demo:
enums.v3 (https://github.com/Programmiermethoden-CampusMinden/PM-Lecture/tree/master/markdown/java-jvm/src/enums/v3/)</p>
...
<blockquote><p><sup><sub><strong>Last modified:</strong> abfbbeb (tooling: fix remaining issues, 2025-04-29)<br></sub></sup></p></blockquote>
