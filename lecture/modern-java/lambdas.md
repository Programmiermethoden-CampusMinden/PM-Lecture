...
nested.StudiListNested (https://github.com/Programmiermethoden-CampusMinden/PM-Lecture/blob/master/markdown/modern-java/src/nested/StudiListNested.java)</p>
...
<p align="right">Demo:
nested.DemoAnonymousInnerClass (https://github.com/Programmiermethoden-CampusMinden/PM-Lecture/blob/master/markdown/modern-java/src/nested/DemoAnonymousInnerClass.java)</p>
...
<p align="right">Demo:
nested.DemoLambda (https://github.com/Programmiermethoden-CampusMinden/PM-Lecture/blob/master/markdown/modern-java/src/nested/DemoLambda.java)</p>
