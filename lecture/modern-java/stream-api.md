...
<p align="right">Demo:
streams.Demo (https://github.com/Programmiermethoden-CampusMinden/PM-Lecture/blob/master/markdown/modern-java/src/streams/Demo.java)</p>
...
> finden Sie die Klasse `Main`, in der die Methoden `Main#a`, `Main#b`
> und `Main#c` “klassisch” mit `for`-Schleifen implementiert wurden.
>
> Führen Sie für die drei Methoden `Main#a`, `Main#b` und `Main#c` ein
