...
>
> Zum Automatisieren von Arbeitsabläufen (Kompilieren, Testen, ...)
> stehen in der Java-Welt verschiedene Tools zur Verfügung: Apache Ant,
> Apache Maven und Gradle sind sicher die am bekanntesten darunter.
>
...
> Kompilieren, Testen, Aufräumen, ... erledigen lassen. Dazu gibt es
> eine breite Palette an vordefinierten Tasks. Zusätzlich sind
> umfangreiche Operationen auf dem Filesystem möglich (Ordner erstellen,
> löschen, Dinge kopieren, ...).
>
